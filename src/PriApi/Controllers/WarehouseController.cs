...
namespace PriApi.Controllers
{
    ...
    {
        private readonly IWarehouseServices _customer;

        public WarehouseController(IWarehouseServices customer)
        {
            _customer = customer;
        }
        ...
        // GET: api/Invoice
        [HttpGet]
        public IActionResult Get([FromBody] WarehouseParams parmas)
        {
